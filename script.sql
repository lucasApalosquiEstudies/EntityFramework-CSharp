...
CREATE TABLE [Post] (
    ...
    [Body] TEXT NOT NULL,
    [Slug] VARCHAR(80) NOT NULL,
    [CreateDate] DATETIME NOT NULL DEFAULT '2023-11-29T18:38:47.3028889Z',
    [LastUpdateDate] DATETIME NOT NULL DEFAULT '2023-11-29T18:38:47.3060594Z',
    [CategoryId] int NULL,
    [AuthorId] int NULL,
    CONSTRAINT [PK_Post] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Post_Author] FOREIGN KEY ([AuthorId]) REFERENCES [User] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_Post_Category] FOREIGN KEY ([CategoryId]) REFERENCES [Category] ([Id]) ON DELETE NO ACTION
);
GO
...
VALUES (N'20231129183847_intial', N'5.0.9');
GO
